...
if __name__ == '__main__': 
    for k in range(1,21):
        for i in range(1,11):
            ...
            path_to_lstm_model = '/RQ1/SleepEDF/Oversampling/models/lstm/lstm_oversampling_outerloop'+str(k)+'_'+'innerloop'+str(i)+'.tar'
            ...
            path_to_results='/RQ1/SleepEDF/Oversampling/results/lstm/lstm_oversampling_outerloop'+str(k)+'.xlsx'
