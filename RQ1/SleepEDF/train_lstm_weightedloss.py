...
if __name__ == '__main__': 
    for k in range(1,21):
        for i in range(1,11):
            ...
            path_to_lstm_model = '/RQ1/SleepEDF/models/lstm/lstm_weightedloss_outerloop'+str(k)+'_'+'innerloop'+str(i)+'.tar'
            ...
            path_to_file_length_test='/sleep-edf/20-folder-trainvalid-test/Outloop'+str(k)+'/PklFiles/valid'+str(i-1)+'.pkl'
            ...
            path_to_results='/RQ1/SleepEDF/results/lstm_weightedloss_outerloop'+str(k)+'.xlsx'
