...
if __name__ == '__main__': 
    ...
    path_to_cnn_model = '/RQ1/SHHS/WeightedLoss/models/cnn_weightedloss.tar'
    ...
    path_to_file_length_cumul='/shhs/train/trainFilesNum30secEpochsCumulative_all_shhs1.pkl'
    f_file_length_cumul=open(path_to_file_length_cumul,'rb')
    f_file_length_dic_cumul=pickle.load(f_file_length_cumul)
    path_to_results='/RQ1/SHHS/WeightedLoss/results/cnn_weightedloss.xlsx'
    ...
    dic_train, dic_train_instances=utils.class_distribution(path_to_hdf5_file_train)
    dic_test, dic_test_instances=utils.class_distribution(path_to_hdf5_file_test)
    ...
    data_train = DataLoader(dataset_train, batch_size=1, num_workers=16,batch_sampler=batch_sampler_random_shuffling)
